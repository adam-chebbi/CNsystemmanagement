...
import { X, Monitor, LogOut, Eye, ShieldCheck, History as HistoryIcon, Loader2, AlertCircle } from 'lucide-react';
...
export const SessionsModal: React.FC<SessionsModalProps> = ({ fullName, onClose, onCurrentSessionRevoked }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in">
      <div className="relative w-full max-w-3xl max-h-[85vh] flex flex-col bg-white dark:bg-[#151D2A] rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6">
          {isLoading ? (
            ...
            <div className="p-4 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800/60 text-xs text-red-600 dark:text-red-400 flex items-center gap-2">
            ...
            <>
              ...
              <section className="space-y-2">
                <h3 className="text-xs font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
                  <HistoryIcon size={13} className="text-gray-400" />
                  Historique des connexions
                </h3>
                <div className="rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                  <div className="overflow-x-auto max-h-64 overflow-y-auto custom-scrollbar">
                    <table className="w-full text-xs min-w-[640px]">
                      <thead className="bg-gray-50 dark:bg-gray-800/60 text-gray-500 dark:text-gray-400 sticky top-0">
                        <tr>
                          <th className="text-left font-semibold px-3 py-2">Utilisateur</th>
                          <th className="text-left font-semibold px-3 py-2">Activité</th>
                          <th className="text-left font-semibold px-3 py-2">Date</th>
