...
| Marge cible par défaut | 0 à 100 % | 65 % | Marge visée pour tout produit qui ne définit pas sa propre marge cible (voir [Ajouter un nouveau produit](/ajouter-un-produit)). |
