...
| *(+4)* **Coût du personnel** | **Non — toujours le mois civil en cours** | Salaires de base + primes − retenues de tous les employés pour le mois calendaire actuel (jamais réduit par les avances — voir [Ajouter une avance ou une prime](/avance-ou-prime)). Affiché aussi en % du chiffre d'affaires du mois en cours (pas de la période sélectionnée, pour éviter un ratio absurde si vous regardez une seule journée). |
